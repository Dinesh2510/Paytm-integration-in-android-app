...
public class Details extends AppCompatActivity implements PaytmPaymentTransactionCallback {
    ImageView iv;// k
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shortd=(TextView)findViewById(R.id.shortd);
        textViewPrice = findViewById(R.id.textViewPrice);
        iv=(ImageView)findViewById(R.id.imageview);

        desc=getIntent().getStringExtra("shortdesc");
        title = getIntent().getStringExtra("title");
        image=getIntent().getStringExtra("image");
        setTitle(title);
        tv.setText(title);
        shortd.setText(desc);
        Picasso.with(Details.this).load(image).into(iv);
